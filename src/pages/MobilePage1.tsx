...
export default function MobilePage1() {
  const images: GalleryImage[] = [
    ...
    { src: "/WebP/adv/ConcertflyerMockup.webp", label: "Concert Flyer Mockup (2026)" },
    { src: "/WebP/adv/vsbevbar.webp", label: "V's BevBar Branding Kit (2025)", description: "In 2025, I was commissioned by a small local business called V's BevBar to create their logos and brand's image. This business operates a mobile beverage bar that services parties, graduations, weddings, etc. The final design for this logo highlights the energetic and charismatic presence that their service offers through prominent bright colors. In addition, it was imparative that the owener's personality and identity is reflected in the logo, therefore the final design incorporates a stylized 'V' that is reminiscent of the owner's signature." },
